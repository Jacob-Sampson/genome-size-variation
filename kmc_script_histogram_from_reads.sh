...
WORK_DIR=$(pwd)
POPULATIONS=('micrantha_E022' 'micrantha_E023')
...
do
	...
	rm kmer_histogram
	kmc_tools simple kmer_1 $WORK_DIR/plastid_genome/plastid_kmer kmers_subtract kmer_plastid_removed -cs15000000 #generate new kmer dataset with kmers corresponding to plastid genome removed
	rm kmer_1.kmc*
	...
	rm kmer2_histogram
	kmc_tools simple kmer_plastid_removed $WORK_DIR/mito_genome/mito_assembly kmers_subtract kmer_mito_plastid_removed -cs15000000
